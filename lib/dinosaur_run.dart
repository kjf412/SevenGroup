...
import 'package:my_learn_dart/controller/location.dart';
import 'package:my_learn_dart/controller/tree_producer.dart';
import 'package:my_learn_dart/paint/cloud.dart';
import 'package:my_learn_dart/paint/dinosaur.dart';
import 'package:my_learn_dart/paint/portrayal.dart';
import 'package:my_learn_dart/paint/tree.dart';
...
class _DinosaurRunState extends State<DinosaurRun>
  ...
  void initState() {
    ...
    treeProducer = TreeProducer(_layoutWidth, 300);
    cloudList ??= [
...
//      print('hasPassedFrameCount = $hasPassedFrameCount'); //约1~3帧
  ...
  ///恐龙布局
  Widget getDinosaur() {
    double baseTopMargin = 300 - Dinosaur.getWrapSize().height;
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Padding(
                ...
                child: Text(
                  '$score / $maxScore',
                  style: TextStyle(color: tingeColor),
                ),
              ),
            ),
            Offstage(
